...
import pandas as pd
from utils import peakrolling, sidebar, columnnames
...
def main():
    ...
    if st.session_state.selected_file is not None:
        ...
        if st.session_state.now_show:
            tab1, tab2= st.tabs(["Input Generator Data Analysis", "Hour By Hour Data Analysis"])
                ...
                with st.expander("Know what you can do with this tool"):
                    st.markdown('''
                            <p style="text-align: justify">
                                ...
                                <li>perform operations (such as summing two columns to create a new column)
                                <li>sort by column(s) </li>
                                <li>get rolling peak with or without grouping on the other column(s)</li>
                            </p>
                            <p style="text-align: justify">
                            Use this if some of the columns in your data are:
                                
                                ReplicationNum, AirlineIdx, FlightDepTime, DepMarket, 
                                SSCPType", GrpSize, PaxArrTime, PaxSpeed, SSCPDelay, 
                                Visitors, LobbyDelay, DepFlightNumber, PaxType, PaxIDNum
